...
@Injectable()
export class DamageAndSplitDetailsRepository extends EntityRepository<DamageAndSplitDocument> {
  constructor(
    @InjectModel(MODEL_NAMES.DAMAGE_AND_SPLIT_DETAILS)
    protected DamageAndSplitDetailsModel: Model<DamageAndSplitDocument>,
  ) {
