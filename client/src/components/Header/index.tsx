...
const Header = (props: {
  ...
  return (
    <header className="sticky top-0 z-200000 flex w-full border-b border-stroke opacity-100% bg-white dark:border-stroke-dark dark:bg-gray-dark">
      <div className="flex flex-grow items-center justify-between px-4 py-5 shadow-2 md:px-5 2xl:px-10">
        <div className="flex items-center gap-2 sm:gap-4 lg:hidden">
          ...
          <Link className="block flex-shrink-0 lg:hidden" href="/images/logo/logo-dark.svg">
            {/* <Image
              width={32}
              height={32}
              src={"/images/logo/"}
